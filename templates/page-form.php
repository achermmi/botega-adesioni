...
<div class="ba-form-top-actions">
    ...
    <button type="button" class="button button-link-delete ba-delete-btn"
            ...
            data-redirect="<?php echo esc_url( admin_url( 'admin.php?page=botega-adesioni' ) ); ?>">
        🗑️ <?php esc_html_e( 'Elimina record', 'botega-adesioni' ); ?>
    </button>
    <a href="<?php echo esc_url( admin_url( 'admin.php?page=botega-adesioni&ba_export=pdf&record_id=' . $record->id ) ); ?>"
...
<div class="ba-form-footer">
    ...
    <a href="<?php echo esc_url( admin_url( 'admin.php?page=botega-adesioni' ) ); ?>" class="button button-large">
