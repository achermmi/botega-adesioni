...
<h1 class="wp-heading-inline">
    <?php esc_html_e( 'Adesioni – La Botega da la Lavizzara', 'botega-adesioni' ); ?>
</h1>
<a href="<?php echo esc_url( admin_url( 'admin.php?page=botega-adesioni-new' ) ); ?>" class="page-title-action">
...
<div class="ba-filters-panel" id="ba-filters-panel">
    <form method="get" id="ba-filter-form">
        ...
        <div class="ba-search-row">
            ...
            <select name="filter_logic" class="ba-logic-sel">
            ...
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=botega-adesioni' ) ); ?>" class="button">
...
<tr><td colspan="9" class="ba-empty">
    <?php esc_html_e( 'Nessun record trovato.', 'botega-adesioni' ); ?>
</td></tr>
<?php else : ?>
<?php foreach ( $result['rows'] as $r ) :
    $edit_url = admin_url( 'admin.php?page=botega-adesioni-new&id=' . $r->id );
?>
