...
class BA_List_Table {
    ...
    public static function render(): void {
        ...
        // URL base per export (mantiene filtri correnti, funziona in admin e frontend)
        $export_base = is_admin()
            ? add_query_arg( array_merge( $_GET, [ 'page' => 'botega-adesioni' ] ), admin_url( 'admin.php' ) )
            : add_query_arg( $_GET, BA_Frontend_Admin::get_url( 'ba_admin_lista' ) );
